...
Deviations from proposal: (1) The proposed design of this package is for GSS specifically. The final package can be used for any data with similar structure. (2) More robustness tests are included, such as random re-shuffling of treatment status, leave one out falsification exercise.
